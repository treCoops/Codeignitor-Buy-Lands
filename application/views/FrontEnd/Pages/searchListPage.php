                            ...
                            <div class="feat_property home7 style4">
                                <div class="thumb">
                                    ...
                                    <div class="thmb_cntnt style3">
                                        <a class="fp_price" href="#">Rs. <?php echo number_format($data['land_price'], 0, '', ' '); ?><small></small></a>
                                    </div>
                                </div>
                                <div class="details">
                                    <div class="tc_content">
                                        ...
                                        <ul class="prop_details mb0">
                                            <li class="list-inline-item"><a class="text-thm3" href="#"><?php echo $data['land_area'] ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
