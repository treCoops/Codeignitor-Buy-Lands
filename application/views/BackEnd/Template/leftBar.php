<div class="dashboard_sidebar_menu dn-992">
    <ul class="sidebar-menu">
        ...
        <li class="treeview"><a href="<?php echo base_url('BMessage/viewMessage') ?>"><i class="flaticon-envelope"></i><span> Message</span></a></li>
        ...
        <li><a href="<?php echo base_url('BProfile/viewManageProfile') ?>"><i class="flaticon-user"></i> <span>My Profile</span></a></li>
